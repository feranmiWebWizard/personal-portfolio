import image from "../assets/images/seyi-one.jpg";
    ...
    <>
      ...
      >
        <img
          ...
          alt="a smiling man"
        />
        <div className="text-center flex flex-col gap-4 pt-4 md:pt-0">
          <p className="text-lg">Hello, I'm</p>
          <h1 className="text-4xl">Oluwaseyi Afolayan</h1>
          ...
          <span className="flex justify-center">
            <a href="https://github.com/feranmiWebWizard" target="_blank">
              <svg
            ...
            <a
              href="https://www.linkedin.com/in/oluwaseyi-afolayan-7bb33420a/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
