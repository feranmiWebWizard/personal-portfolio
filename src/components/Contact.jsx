  ...
  return (
    ...
    >
      ...
      <div className="md:text-lg border-2 border-gray-700 rounded-[1.5rem] flex gap-4 md:gap-6 px-4 md:px-10 py-4">
        <a className="flex gap-2" href="mailto:afolayancseyi@gmail.com">
          <svg
          ...
          afolayancseyi@gmail.com
        </a>
        <a className="flex gap-2" href="https://www.linkedin.com/in/oluwaseyi-afolayan-7bb33420a/" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
      ...
      <section className="mt-auto">
        ...
        <p className="mt-8 py-4">
          Copyright @ Oluwaseyi Afolayan. All Rights Reserved
        </p>
      </section>
    </div>
  );
