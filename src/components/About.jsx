    ...
    <div id="about" className="flex flex-col justify-center min-h-[100vh]">
      ...
      <section className="flex flex-col md:flex-row items-center justify-center gap-4">
        <div className="text-center border-2 border-gray-600 rounded-[1.5rem] flex flex-col items-center w-[18rem] p-5">
          ...
          <p>
            3+ years <br /> Frontend Development <br />
      ...
      <section className="max-w-[40rem] mx-auto mt-10 p-4">
        <p>
          Hello, I'm Oluwaseyi, a Frontend Developer who loves indie games and
          growing plants. Whether I'm battling bugs in my code or nurturing my
          succulents, I'm always up for a challenge. When I'm not diving into
          lines of code, you can find me exploring the virtual realms of indie
          games. There's just something magical about the creativity and passion
          that goes into each pixel, and I love being part of those unique
          stories. Let's build cool stuff together!"
        </p>
      </section>
    </div>
  );
